...
\keys{\cmd+\shift+,} Show panel with Sublime settings files \\
\keys{\cmd+\Alt+\arrowkeyup} Toggle user and default settings file \\
\keys{\cmd+\shift+;} Completes current key with default \\
